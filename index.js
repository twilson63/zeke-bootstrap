...
exports.attach = function() {
  ...
  this.helpers['collapseBtn'] = require('./collapse_btn');
  ...
  this.helpers['bsTable'] = require('./table');
  this.helpers['bsNavbar'] = require('./bsNavbar');
  return this.helpers['center'] = function(t) {
    return div({
      'align': 'center'
    }, t);
  };
