...
module.exports = function(navbarData) {
  ...
  navbarclass = "";
  if (navbarData.type !== "basic") {
    navbarclass = ".navbar-" + navbarData.type;
  }
  if (navbarData.inverted) {
  ...
  return div("\#" + navbarData.id + ".navbar" + navbarclass, function() {
    return div('.navbar-inner', function() {
      return div('.container', function() {
        var activestring, itemtxt, pullstring, _j, _len1, _ref1, _results;
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          if (item.type === "brand") {
            ...
            if (item.collapseable) {
              text("<div class=\"nav-collapse\">");
            }
            pullstring = "";
            if (item.pull) {
              pullstring = ".pull-" + item.pull;
            }
            activestring = "";
            if (item.name === navbarData.selected) {
              activestring = ".active";
            }
                ...
                case "dropdown":
                  return li("\#" + item.name + activestring + ".dropdown", function() {
                    ...
                    return ul('.dropdown-menu', function() {
                      var dropdownItem, dropdownItemtxt, _k, _len2, _ref2, _results1;

                      _ref2 = item.dropdownItems;
                      _results1 = [];
                      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                        dropdownItem = _ref2[_k];
                        ...
                        switch (dropdownItem.type) {
                          ...
                          case "divider":
                            ...
                            break;
                          case "header":
                            _results1.push(li(".nav-header", dropdownItemtxt));
                            break;
                          default:
                            _results1.push(text(downdownItemtxt));
                        }
                      }
                      return _results1;
                    });
